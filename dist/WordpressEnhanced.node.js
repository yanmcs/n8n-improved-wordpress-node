...
// Import Credentials
const WordpressApiCredentials_credentials_1 = require("./WordpressApiCredentials.credentials"); // Update filename
...
class WordpressEnhanced {
    constructor() {
        this.description = {
            ...
            credentials: [
                WordpressApiCredentials_credentials_1.WordpressApiCredentials, // Use the credential class directly
