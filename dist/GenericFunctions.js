 ...
 */
async function wordpressApiRequest(method, endpoint, body = {}, qs = {}) {
    // Get credentials
 ...
 */
async function wordpressApiRequestAllItems(endpoint, qs = {}) {
    const returnData = [];
    let response;
    let queryParameters = Object.assign(Object.assign({}, qs), { page: 1, per_page: 100 }); // Start with page 1, max 100 per page
    ...
    do {
        ...
        if (Array.isArray(response)) {
            ...
            queryParameters.page = queryParameters.page + 1;
        }
        else {
